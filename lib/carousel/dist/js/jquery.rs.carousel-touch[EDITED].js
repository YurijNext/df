...
(function ($) {
    ...
    $.widget('rs.carousel', $.rs.carousel, {
        ...
        options: {
            touch: true,
            sensitivity: 1 // 0.5 is EDITED VALUE ( custom 1)
        },
        ...
        _dragStopHandler: function (e) {
            ...
            if (speed > this.options.sensitivity || distance > this._getMaskDim() / 100000000) { // 10000 is EDITED VALUE ( custom 2) touch sensitivity
